          ...
          <div className="mt-10 rounded-3xl border border-secondary/20 bg-secondary/5 p-6">
            ...
            <div className="flex items-start gap-4">
              ...
              <p className="leading-8 text-text-secondary">
                ...
                By submitting this consultation request, you consent
                to HAB Global Consulting contacting you regarding
                your enquiry. Your information will be handled in
...
function SummaryItem({
  ...
  return (
    ...
    <div className="grid gap-2 md:grid-cols-[220px_1fr]">
      ...
      <span className="leading-8 text-text-secondary">
